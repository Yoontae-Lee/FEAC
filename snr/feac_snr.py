...
plt.tight_layout()
# Save
plt.savefig("feac_snr.png")  
print("Plot saved as feac_snr.png")
...
df.to_excel("feac_snr.xlsx", index=False)

print("Results saved to feac_snr.xlsx")