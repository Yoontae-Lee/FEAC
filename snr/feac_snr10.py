...
plt.tight_layout()
# Save
plt.savefig("feac_snr10.png")  
print("Plot saved as feac_snr10.png")
...
df.to_excel("feac_snr10.xlsx", index=False)

print("Results saved to feac_snr10.xlsx")