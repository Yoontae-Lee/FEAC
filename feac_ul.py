...
for round in range(COMMUNICATION_ROUNDS):
    ...
    # Proceed with aggregation if there are participating clients
...
plt.tight_layout()
# Save
plt.savefig("feac_ul.png")  
print("Plot saved as feac_ul.png")
...
df.to_excel("feac_ul.xlsx", index=False)

print("Results saved to feac_ul.xlsx")
