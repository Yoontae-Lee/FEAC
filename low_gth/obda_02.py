...
plt.tight_layout()
# Save
plt.savefig("obda_02.png")  
print("Plot saved as obda_02.png")
...
df.to_excel("obda_02.xlsx", index=False)

print("Results saved to obda_02.xlsx")
