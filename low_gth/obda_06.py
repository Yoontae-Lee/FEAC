...
plt.tight_layout()
# Save
plt.savefig("obda_06.png")  
print("Plot saved as obda_06.png")
...
df.to_excel("obda_06.xlsx", index=False)

print("Results saved to obda_06.xlsx")
